...
public class EnhancedCommandsDataGenerationImpl {
  ...
  public static void gatherData(GatherDataEvent.Client event) {
    event.createProvider((arg, completableFuture) -> new TagGenerationBridgeImpl.ForBlock(arg, completableFuture, EnhancedCommands.MOD_ID, new BlockTagDataGeneration()));
