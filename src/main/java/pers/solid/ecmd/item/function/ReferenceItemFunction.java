...
public record ReferenceItemFunction(Holder.Reference<ItemFunction> reference) implements ItemFunction, ReferenceEntry<ItemFunction> {
  ...
  public static final PrefixedIdParser<ReferenceItemFunction, ItemFunction> PREFIXED_ID_PARSER = new PrefixedIdParser<>('$', Component.translatable("enhanced_commands.block_predicate.reference"), ItemFunction.REGISTRY_KEY, ReferenceItemFunction::new);
