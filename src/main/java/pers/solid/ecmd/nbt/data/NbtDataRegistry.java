...
public final class NbtDataRegistry {
  ...
  public static @Nullable NbtSource<?> handleSource(String type, ParseContext<?> parseContext) throws CommandSyntaxException {
  ...
  public static @Nullable NbtTarget<?> handleTarget(String type, ParseContext<?> parseContext) throws CommandSyntaxException {
