...
public interface Parser<T> {
   ...
   * @param parser          包含 {@link StringReader} 和 {@link SuggestionAppender} 的对象。解析过程中，可以移动其 {@code cursor}，并指定如何提供建议。
   ...
   */
  T parse(CommandRegistryAccess registryAccess, SuggestedParser<?> parser, boolean suggestionsOnly, boolean allowSparse) throws CommandSyntaxException;
}
