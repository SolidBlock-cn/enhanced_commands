...
public record ScoreEntityPredicateEntry(List<Entry> scores) implements EntityPredicateEntry, StaticEntityPredicate {
  public static final MapCodec<ScoreEntityPredicateEntry> CODEC = Entry.CODEC.listOf().fieldOf("scores").xmap(ScoreEntityPredicateEntry::new, ScoreEntityPredicateEntry::scores);
  ...
  @Override
  public @NotNull EntityPredicateType<ScoreEntityPredicateEntry> getType() {
