...
/**
 * 此类为不需要借助 {@link ExecutionContext} 就能运作的实体谓词，将能直接继承 {@link Predicate#test(Object)} 并存储于 {@link net.minecraft.commands.arguments.selector.EntitySelector#predicates} 中。
 */
