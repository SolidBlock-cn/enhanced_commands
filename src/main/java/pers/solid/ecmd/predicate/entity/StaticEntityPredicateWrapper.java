...
/**
 * <p>可用于包装原版的 {@code Predicate<Entity>}、存储于原版的 {@link net.minecraft.command.EntitySelector#predicates} 并借此包装一个本模组的 {@link EntityPredicate} 对象的类。其行为将于原版的 {@link #vanillaPredicate} 一致，不过在进行反序列化以及谓词时，会使用到 {@link EntityPredicate} 中的信息。
