...
public record KeywordArgsArgument(@Unmodifiable Map<@NotNull String, ArgumentType<?>> arguments, Set<String> requiredArguments, @Unmodifiable Map<@NotNull String, Object> defaultValues, Set<ResourceLocation> shared, Set<String> argumentsFromShared) implements ArgumentType<KeywordArgs> {
  ...
  public static class Builder {
    ...
    public Builder addAll(KeywordArgsArgument source) {
    ...
    public Builder addShared(Function<CommandBuildContext, KeywordArgsArgument> source, CommandBuildContext commandBuildContext) {
      shared.add(KeywordArgsCommon.getIdOrThrow(source));
      final KeywordArgsArgument apply = source.apply(commandBuildContext);
    ...
    public KeywordArgsArgument build() {
      return new KeywordArgsArgument(arguments.build(), requiredArguments.build(), defaultValues.build(), shared.build(), argumentsFromShared.build());
    }
  }
}
