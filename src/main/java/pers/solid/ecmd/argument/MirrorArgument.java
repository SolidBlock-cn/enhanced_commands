...
public enum MirrorArgument implements StringRepresentable, Function<@NotNull CommandSourceStack, @NotNull Mirror> {
  NONE(Mirror.NONE),
  ...
  MirrorArgument(String name, Function<@NotNull CommandSourceStack, @NotNull Mirror> function) {
    this.name = name;
    this.function = function;
  }

  MirrorArgument(Mirror blockMirror) {
