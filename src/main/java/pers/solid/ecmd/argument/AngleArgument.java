...
public record AngleArgument(boolean returnRadians, double min, double max) implements ArgumentType<Double>, ArgumentTypeInfo.Template<AngleArgument> {
  public static AngleArgument angle(boolean returnRadians, double minimum, double maximum) {
    return new AngleArgument(returnRadians, minimum, maximum);
  }

  public static AngleArgument angle(boolean returnRadians) {
    return new AngleArgument(returnRadians, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
  }
  ...
  public static class Info implements ArgumentTypeInfo<AngleArgument, AngleArgument> {
    ...
    @Override
    public void serializeToNetwork(AngleArgument properties, FriendlyByteBuf buf) {
    ...
    public @NotNull AngleArgument deserializeFromNetwork(FriendlyByteBuf buf) {
      ...
      return new AngleArgument(returnRadians, d, e);
    }

    @Override
    public void serializeToJson(AngleArgument properties, JsonObject json) {
