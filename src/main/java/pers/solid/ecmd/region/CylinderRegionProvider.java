...
public record CylinderRegionProvider(@Range(from = 0, to = Long.MAX_VALUE) double radius, @Range(from = 0, to = Long.MAX_VALUE) double height, @NotNull EnhancedCoordinates center) implements RegionProvider<CylinderRegion> {
