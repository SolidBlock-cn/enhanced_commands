...
public record IntersectRegionArgument(@NotNull List<RegionArgument<?>> regions) implements RegionArgument<IntersectRegion> {
  ...
  @Override
  public IntersectRegion toAbsoluteRegion(ServerCommandSource source) throws CommandSyntaxException {
    return new IntersectRegion(IterateUtils.transformFailableImmutableList(regions, regionArgument -> regionArgument.toAbsoluteRegion(source)));
  }
