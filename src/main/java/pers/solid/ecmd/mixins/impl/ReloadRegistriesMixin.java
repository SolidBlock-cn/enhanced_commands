...
public class ReloadRegistriesMixin {
  ...
  private static Stream<CompletableFuture<WritableRegistry<?>>> appendMoreFutures(Stream<CompletableFuture<WritableRegistry<?>>> instance, @Local RegistryOps<JsonElement> ops, @Local(argsOnly = true) ResourceManager resourceManager, @Local(argsOnly = true) Executor prepareExecutor) {
