...
public interface EnchantmentModificationType<T extends EnchantmentsFunction> {
  ...
  record Simple<T extends EnchantmentsFunction>(MapCodec<T> codec) implements EnchantmentModificationType<T> {}
}
