...
public class BlockTagDataGeneratorImpl extends FabricTagProvider.BlockTagProvider {
  public BlockTagDataGeneratorImpl(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
